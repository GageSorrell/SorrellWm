...
```md
<span style="font-size: 12px;">Documentation for ${PRODUCT_NAME}.  (c) 2024&ndash;${CURRENT_YEAR} Gage Sorrell.  Provided under the [MIT License](${NEAREST_LICENSE_MD_FILE}).</span>
```
