...
export/**
       * The values of {@link FKeyId}, made available at runtime.
       */
const KeyIds: ReadonlyArray<FKeyId> =
    [
        "MouseX1",
        "MouseX2",
        "Backspace",
 ...
 */
export function IsKeyId(In: string): In is FKeyId
{
    return KeyIds.includes(In as FKeyId);
};
 ...
 */
export function GetKeyName(VkCode: FVirtualKey): FKeyId
{
...
export/**
       * Developer-friendly names of key codes.
       */
const Vk: Readonly<Record<FKeyId, FVirtualKey>> =
    {
        MouseX1: 0x05,
        MouseX2: 0x06,
        Backspace: 0x08,
...
export/**
       * A {@link ReadonlyArray} of all {@link FVirtualKey | FVirtualKeys}
       * available to Electron.
       */
const VirtualKeys: ReadonlyArray<FVirtualKey> =
    [
        0x05,
        0x06,
        0x08,
 ...
 * an {@link FVirtualKey}.
 */
export function IsVirtualKey(KeyCode: number): KeyCode is FVirtualKey
{
