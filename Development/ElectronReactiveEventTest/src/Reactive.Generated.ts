 ...
 * ********************************************
 *
 * Generated with the all command.
...
export type PackageKey = "electronreactiveeventtest";
...
export type ResponseSync<ChannelType extends Channel.Handler.Response> = ResponseSyncImported<PackageKey, ChannelType>;
