...
export function ImpulseBackgroundBox({ ImpulseKey, Duration = 350, FrameDuration = 16, children }) {
    ...
    return (_jsx(Ink.Box, { backgroundColor: BackgroundColor, paddingX: 1, children: children }));
}
function GetImpulseBackgroundColor(Progress) {
    if (Progress >= 1) {
        return undefined;
    }
...
function FormatRgbAsHex(Red, Green, Blue) {
    const ToHex = Function.flow((In) => In.toString(16), String.padStart(2, "0"), String.toUpperCase);
