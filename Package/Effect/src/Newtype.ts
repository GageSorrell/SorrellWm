 ...
 *
 * ```ts
 * import { Newtype } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Equivalence, Newtype } from "@sorrell/effect"
 *
 * interface Label extends Newtype.Newtype<"Label", string> {}
 *
 ...
 *
 * ```ts
 * import { Newtype, Order } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Combiner, Newtype } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Newtype, Reducer } from "@sorrell/effect"
 *
 * interface Score extends Newtype.Newtype<"Score", number> {}
 *
