 ...
 *
 * ```ts
 * import { Effect, TxQueue, TxSubscriptionRef } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, TxSubscriptionRef } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Effect, Stream, TxSubscriptionRef } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const ref = yield* TxSubscriptionRef.make(0)
 *   yield* TxSubscriptionRef.set(ref, 1)
 ...
 *
 * ```ts
 * import { TxSubscriptionRef } from "@sorrell/effect"
 *
