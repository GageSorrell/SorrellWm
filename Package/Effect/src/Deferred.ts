 ...
 *
 * ```ts
 * import { Deferred, Effect, Fiber } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Deferred } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Deferred, Effect } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Deferred, Effect, Exit } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const deferred = yield* Deferred.make<number>()
 ...
 *
 * ```ts
 * import { Cause, Deferred, Effect } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const deferred = yield* Deferred.make<number, string>()
