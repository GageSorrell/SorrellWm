 ...
 *
 * ```ts
 * import { Context, Effect, Layer, Scope } from "@sorrell/effect"
 *
 * class Database extends Context.Service<Database, {
 *   readonly query: (sql: string) => Effect.Effect<string>
 * }>()("Database") {}
 ...
 *
 * ```ts
 * import { Console, Layer } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Layer } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Context, Layer } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Context, Data, Effect, Layer } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Context, Effect, Layer, Ref } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Context, Effect, Layer } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Layer } from "@sorrell/effect"
 *
 ...
 * ```ts
 * import { Console, Context, Effect, Layer } from "@sorrell/effect"
 * import type { Tracer } from "@sorrell/effect"
 *
 * class Database extends Context.Service<Database, {
 *   readonly query: (sql: string) => Effect.Effect<string>
 * }>()("Database") {}
 ...
 *
 * ```ts
 * import { Console, Context, Effect, Layer, Tracer } from "@sorrell/effect"
 *
 * class Database extends Context.Service<Database, {
 *   readonly query: (sql: string) => Effect.Effect<string>
 * }>()("Database") {}
 ...
 *
 * ```ts
 * import { Context, Effect, Layer, Tracer } from "@sorrell/effect"
 *
 * class Database extends Context.Service<Database, {
 *   readonly query: (sql: string) => Effect.Effect<string>
 * }>()("Database") {}
