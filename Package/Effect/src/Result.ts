 ...
 *
 * ```ts
 * import { Result } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import type { Result } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Equivalence, Result } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { pipe, Result } from "@sorrell/effect"
 *
 * const result = pipe(
 *   Result.succeed(1),
 *   Result.mapBoth({
