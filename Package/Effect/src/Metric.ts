...
export declare namespace Metric {
   ...
   *
   * ```ts
   * import { Metric } from "@sorrell/effect"
   *
 ...
 *
 * ```ts
 * import { Data, Duration, Effect, Metric } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Data, Effect, Metric } from "@sorrell/effect"
 *
 * class SnapshotError extends Data.TaggedError("SnapshotError")<{
 *   readonly operation: string
 * }> {}
 ...
 *
 * ```ts
 * import { Data, Effect, Layer, Metric } from "@sorrell/effect"
 *
 * class MetricsError extends Data.TaggedError("MetricsError")<{
 *   readonly operation: string
 * }> {}
 ...
 * ```ts
 * import { Data, Effect, Layer, Metric } from "@sorrell/effect"
 * import type { Context, Exit } from "@sorrell/effect"
 *
 * class MetricsError extends Data.TaggedError("MetricsError")<{
 *   readonly operation: string
 * }> {}
 ...
 *
 * ```ts
 * import { Console, Data, Effect, Layer, Metric } from "@sorrell/effect"
 *
