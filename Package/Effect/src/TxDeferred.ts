 ...
 *
 * ```ts
 * import { Effect, TxDeferred } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Option, TxDeferred } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Effect, Option, Result, TxDeferred } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const deferred = yield* TxDeferred.make<number>()
 ...
 *
 * ```ts
 * import { Effect, Result, TxDeferred } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
