 ...
 *
 * ```ts
 * import { Effect, Exit, Scope } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Exit, Scope } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
...
export declare namespace State {
   ...
   *
   * ```ts
   * import { Scope } from "@sorrell/effect"
   *
 ...
 *
 * ```ts
 * import { Effect, Scope } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
