 ...
 *
 * ```ts
 * import { Effect, ExecutionPlan, Schedule } from "@sorrell/effect"
 * import type { Layer } from "@sorrell/effect"
 * import type { LanguageModel } from "@sorrell/effect/unstable/ai"
 *
