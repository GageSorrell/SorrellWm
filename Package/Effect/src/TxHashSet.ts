 ...
 *
 * ```ts
 * import { Effect, TxHashSet } from "@sorrell/effect"
 *
...
export declare namespace TxHashSet {
   ...
   *
   * ```ts
   * import type { TxHashSet } from "@sorrell/effect"
   *
 ...
 *
 * ```ts
 * import { Effect, HashSet, TxHashSet } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Effect, Equal, Hash, TxHashSet } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const txSet = yield* TxHashSet.make("apple", "banana", "cherry")
 *
