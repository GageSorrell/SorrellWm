...
export const CookiesSchema: CookiesSchema = Schema.declare(
  isCookies,
  {
    ...
    generation: {
      ...
      importDeclaration: `import * as Cookies from "@sorrell/effect/unstable/http/Cookies"`
    },
    expected: "Cookies",
    toCodecJson: () =>
      Schema.link<Cookies>()(
...
export const CookieSchema: CookieSchema = Schema.declare(
  isCookie,
  {
    ...
    generation: {
      ...
      Type: `Cookies.Cookie`,
      importDeclaration: `import * as Cookie from "@sorrell/effect/unstable/http/Cookies"`
    },
    expected: "Cookie"
  }
)
