 ...
 *
 * ```ts
 * import type { Record } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import type { HKT, Record } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Record } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Option, Record as R } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 ...
 *
 * ```ts
 * import { Record, Result } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 * const x = { a: 1, b: 2, c: 3 }
 ...
 *
 * ```ts
 * import { Option, Record } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 * assert.deepStrictEqual(
 ...
 *
 * ```ts
 * import { Equivalence, Record } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Equal, Record } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
