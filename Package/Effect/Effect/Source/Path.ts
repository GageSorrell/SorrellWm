 ...
 * @since 4.0.0
 */
import * as PathService from "./Context.ts"
 ...
 *
 * ```ts
 * import { Effect, Path } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Layer, Path } from "@sorrell/effect"
 *
 ...
 * @since 4.0.0
 */
export const Path: PathService.Service<Path, Path> = PathService.Service("effect/Path")
