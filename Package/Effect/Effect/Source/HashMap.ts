 ...
 *
 * ```ts
 * import { HashMap } from "@sorrell/effect"
 *
 * // Create a HashMap
...
export declare namespace HashMap {
   ...
   *
   * ```ts
   * import { HashMap, Option } from "@sorrell/effect"
   *
 ...
 *
 * ```ts
 * import { Hash, HashMap } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Hash, HashMap, Option } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { HashMap, Result } from "@sorrell/effect"
 *
 * const map1 = HashMap.make(["a", 1], ["b", 2], ["c", 3], ["d", 4])
