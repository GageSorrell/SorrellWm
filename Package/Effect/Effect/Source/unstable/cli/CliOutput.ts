 ...
 * support.
 *
 * @module @sorrell/effect/unstable/cli/CliOutput
 * @since 4.0.0
 */
...
/* eslint-disable @typescript-eslint/naming-convention, @typescript-eslint/typedef, jsdoc/require-jsdoc,
 ...
 * import { CliOutput } from "@sorrell/effect/unstable/cli"
 *
...
export interface Formatter
{
     ...
     *
     * ```ts
     * import { Option as O } from "@sorrell/effect"
     * import { CliOutput } from "@sorrell/effect/unstable/cli"
     * import type { HelpDoc } from "@sorrell/effect/unstable/cli"
     *
     ...
     *
     * ```ts
     * import { CliError, CliOutput } from "@sorrell/effect/unstable/cli"
     *
