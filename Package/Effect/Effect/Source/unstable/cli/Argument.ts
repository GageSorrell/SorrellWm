 ...
 *
 * @module @sorrell/effect/unstable/cli/Argument
 * @since 4.0.0
 */
...
import { type LazyArg, dual } from "../../Function.ts";
 ...
 *
 * ```ts
 * import { Argument, Prompt } from "@sorrell/effect/unstable/cli"
 *
 * const filename = Argument.string("filename").pipe(
 ...
 * import { Argument, CliError } from "@sorrell/effect/unstable/cli"
 *
