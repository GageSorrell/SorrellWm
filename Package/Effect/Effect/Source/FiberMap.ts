 ...
 *
 * ```ts
 * import { Effect, FiberMap } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Fiber, FiberMap } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Deferred, Effect, Fiber, FiberMap } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const map = yield* FiberMap.make<string>()
 ...
 *
 * ```ts
 * import { Context, Effect, FiberMap } from "@sorrell/effect"
 *
 * interface Users {
