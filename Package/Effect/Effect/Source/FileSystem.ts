 ...
 *
 * ```ts
 * import { Console, Effect, FileSystem } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, FileSystem, PlatformError } from "@sorrell/effect"
 *
...
export declare namespace File {
   ...
   *
   * ```ts
   * import { Effect, FileSystem, Option } from "@sorrell/effect"
   *
   * const program = Effect.gen(function*() {
   *   const fs = yield* FileSystem.FileSystem
   *
 ...
 *
 * ```ts
 * import { Effect, FileSystem, Option, Stream } from "@sorrell/effect"
 *
