 ...
 * @since 2.0.0
 */
import type * as TheEffect from "./Array.ts"
 ...
 *
 * ```ts
 * import { Console, Effect } from "@sorrell/effect"
 *
...
export const validate: {
  ...
  ): (elements: Iterable<A>) => Effect<Array<B>, TheEffect.NonEmptyArray<E>, R>
  <A, B, E, R>(
    f: (a: A, i: number) => Effect<B, E, R>,
    options: {
      readonly concurrency?: Concurrency | undefined
  ...
  ): (elements: Iterable<A>) => Effect<void, TheEffect.NonEmptyArray<E>, R>
  <A, B, E, R>(
    elements: Iterable<A>,
    f: (a: A, i: number) => Effect<B, E, R>,
    options?: {
  ...
  ): Effect<Array<B>, TheEffect.NonEmptyArray<E>, R>
  <A, B, E, R>(
    elements: Iterable<A>,
    f: (a: A, i: number) => Effect<B, E, R>,
    options: {
  ...
  ): Effect<void, TheEffect.NonEmptyArray<E>, R>
} = internal.validate
...
export const forEach: {
  <B, E, R, S extends Iterable<any>, const Discard extends boolean = false>(
    f: (a: TheEffect.ReadonlyArray.Infer<S>, i: number) => Effect<B, E, R>,
    options?: { readonly concurrency?: Concurrency | undefined; readonly discard?: Discard | undefined } | undefined
  ): (self: S) => Effect<Discard extends false ? TheEffect.ReadonlyArray.With<S, B> : void, E, R>
  <B, E, R, S extends Iterable<any>, const Discard extends boolean = false>(
    self: S,
    f: (a: TheEffect.ReadonlyArray.Infer<S>, i: number) => Effect<B, E, R>,
    options?: { readonly concurrency?: Concurrency | undefined; readonly discard?: Discard | undefined } | undefined
  ): Effect<Discard extends false ? TheEffect.ReadonlyArray.With<S, B> : void, E, R>
} = internal.forEach
 ...
 *
 * ```ts
 * import { Data, Effect } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Effect } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Result } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Option } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Data, Effect, pipe } from "@sorrell/effect"
 *
 * class DiscountRateError extends Data.TaggedError("DiscountRateError")<{}> {}
 *
 ...
 *
 * ```ts
 * import { Console, Data, Effect, pipe } from "@sorrell/effect"
 *
 * class DiscountRateError extends Data.TaggedError("DiscountRateError")<{}> {}
 *
 * // Function to apply a discount safely to a transaction amount
 ...
 *
 * ```ts
 * import { Console, Effect, Option } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
...
export const catchTag: {
  <
    const K extends Tags<E> | TheEffect.NonEmptyReadonlyArray<Tags<E>>,
    E,
    A1,
    E1,
    R1,
  ...
  >(
    k: K,
    f: (e: ExtractTag<NoInfer<E>, K extends TheEffect.NonEmptyReadonlyArray<string> ? K[number] : K>) => Effect<A1, E1, R1>,
    orElse?:
      | ((e: ExcludeTag<E, K extends TheEffect.NonEmptyReadonlyArray<string> ? K[number] : K>) => Effect<A2, E2, R2>)
      | undefined
  ): <A, R>(
    self: Effect<A, E, R>
  ) => Effect<
    ...
    | E1
    | E2
    | (A2 extends unassigned ? ExcludeTag<E, K extends TheEffect.NonEmptyReadonlyArray<string> ? K[number] : K> : never),
    R | R1 | R2
  >
  <
    A,
  ...
  >(
    self: Effect<A, E, R>,
    k: K,
    f: (e: ExtractTag<E, K extends TheEffect.NonEmptyReadonlyArray<string> ? K[number] : K>) => Effect<A1, E1, R1>,
    orElse?:
      | ((e: ExcludeTag<E, K extends TheEffect.NonEmptyReadonlyArray<string> ? K[number] : K>) => Effect<A2, E2, R2>)
      | undefined
  ): Effect<
 ...
 *
 * ```ts
 * import { Cause, Console, Effect } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Data, Effect, Filter } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Data, Effect } from "@sorrell/effect"
 *
 * class NetworkError extends Data.TaggedError("NetworkError")<{
 *   statusCode: number
 * }> {}
...
export const tapErrorTag: {
  <const K extends Tags<E> | TheEffect.NonEmptyReadonlyArray<Tags<E>>, E, A1, E1, R1>(
    k: K,
    f: (e: ExtractTag<NoInfer<E>, K extends TheEffect.NonEmptyReadonlyArray<string> ? K[number] : K>) => Effect<A1, E1, R1>
 ...
 *
 * ```ts
 * import { Data, Effect, Schedule } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Data, Effect, Schedule } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Context, Effect, ExecutionPlan, Layer } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Duration, Effect } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Duration, Effect } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Console, Data, Effect, Result } from "@sorrell/effect"
 *
 * class TaskError extends Data.TaggedError("TaskError")<{ readonly message: string }> {}
 *
 ...
 *
 * ```ts
 * import { Console, Context, Effect, Option } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Context, Effect, Layer } from "@sorrell/effect"
 *
 * interface Database {
 ...
 *
 * ```ts
 * import { Context, Effect } from "@sorrell/effect"
 *
 * // Define service keys
 * const Logger = Context.Service<{
 *   log: (msg: string) => void
 ...
 *
 * ```ts
 * import { Context, Effect, Option } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Context, Effect } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Scope } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Exit } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Console, Data, Effect } from "@sorrell/effect"
 *
 * class TaskError extends Data.TaggedError("TaskError")<{ readonly message: string }> {}
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Fiber } from "@sorrell/effect"
 *
 ...
 * ```ts
 * // Success Example
 * import { Console, Effect, Schedule } from "@sorrell/effect"
 *
 ...
 * ```ts
 * // Failure Example
 * import { Effect, Schedule } from "@sorrell/effect"
 *
 * let count = 0
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Option, Schedule } from "@sorrell/effect"
 *
 * let attempt = 0
 * const task = Effect.gen(function*() {
 *   attempt++
 ...
 *
 * ```ts
 * import { Console, Effect, Exit, Request, RequestResolver } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Fiber } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Fiber, Schedule } from "@sorrell/effect"
 *
 * //      ┌─── Effect<number, never, never>
 * //      ▼
 ...
 *
 * ```ts
 * import { Console, Context, Effect, Exit } from "@sorrell/effect"
 *
 * interface Logger {
 ...
 *
 * ```ts
 * import { Context, Effect, Exit } from "@sorrell/effect"
 *
 * interface Database {
 *   query: (sql: string) => string
 * }
 ...
 *
 * ```ts
 * import { Effect, Logger } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Metric } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Exit, Metric } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Data, Effect, Metric } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Duration, Effect, Metric } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, TxRef } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
