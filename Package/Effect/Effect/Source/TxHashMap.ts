 ...
 *
 * ```ts
 * import { Effect, TxHashMap } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Option, TxHashMap } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const userMap = yield* TxHashMap.make(
 ...
 *
 * ```ts
 * import { Effect, HashMap, TxHashMap } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Effect, Hash, TxHashMap } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Effect, Option, Result, TxHashMap } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, TxHashMap } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
