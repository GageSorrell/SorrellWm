...
import { Data, Effect, Exit, Function, HashMap, HashSet, Layer, Option, type Scope } from "effect";
import type { type Natural, type Percentage } from "../Utility.ts";
import type { ReactNode } from "react";
/* eslint-disable-next-line @typescript-eslint/no-unused-vars */
import type { TaskOutput as TaskOutputComponent } from "../Component/Task/TaskOutput.js";
import { dual, pipe, type FunctionN, type LazyArg } from "effect/Function";
import * as Internal from "./Internal/Task.ts";
...
export const IsTaskHandle = Utility.MakeHandleGuard<Handle>(TypeIdKey);
...
export const Make = (
    Options: Options
): Effect.Effect<Handle, Error.TaskCreationError, TaskService.TaskContext> => Effect.gen(function* ()
{
...
export const MakeSafe = (
    Options: Options
): Effect.Effect<Handle, TaskCreationError, TaskService> => Effect.gen(function* ()
{
    const Service: TaskService = yield* TaskService;
