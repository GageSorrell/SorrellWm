...
import {
    type EffectCallbackHandle,
    type EffectFailureState,
    type EffectFiberState,
    type EffectPendingState,
    type EffectSuccessState,
    type EffectValueState,
    type FiberDoneState,
    type FiberIdleState,
    type FiberRunningState,
...
const EffectContext: ReactContext<Context.Context<never> | undefined> =
...
{
    const RuntimeContext: Context.Context<never> | undefined = useContext(EffectContext);
...
{
    const RuntimeContext: Context.Context<R> = useRuntimeContext<R>();
    ...
    | never =>
{
    ...
    const RuntimeContext: Context.Context<R> | undefined = useOptionalRuntimeContext<R>();
