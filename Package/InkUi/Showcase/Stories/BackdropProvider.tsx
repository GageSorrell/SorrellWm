/**
 * Showcase story for backdrop provider.
 *
...
const Explicit = (): React.ReactElement =>
    <BackdropProvider backgroundColor="#111827">
        <Ink.Text>
            Custom backdrop
        </Ink.Text>
    </BackdropProvider>;
...
export default SimpleStory({
    ...
    [
        {
            Code: "<BackdropProvider backgroundColor=\"#111827\">{ /* ... */ }</BackdropProvider>",
            Preview: Explicit,
