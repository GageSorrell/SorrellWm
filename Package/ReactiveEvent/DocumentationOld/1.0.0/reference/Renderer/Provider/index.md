[reactive-event](../../index.md) / Renderer/Provider
...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [ReactiveEventProvider](functions/ReactiveEventProvider.md) | This is what provides the `reactive-event` hooks with the necessary IPC functions from [IpcRenderer](https://www.electronjs.org/docs/latest/api/ipc-renderer). This must wrap your application where `reactive-event` is used. |
...
| [ReactiveEventInternalContext](variables/ReactiveEventInternalContext.md)    | This is the context used by `reactive-event`.                                                                                                                  |
