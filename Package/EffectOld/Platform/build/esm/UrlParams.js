 ...
 * @category schemas
 */
export const schemaFromSelf = Schema.Array(Schema.Tuple(Schema.String, Schema.String)).annotations({ identifier: "UrlParams" });
/**
 * @since 1.0.0
 * @category constructors
 */
 ...
 */
export const getAll = dual(2, (self, key) => Arr.reduce(self, [], (acc, [k, value]) => {
    if (k === key) {
        acc.push(value);
    }
    return acc;
 ...
 * @category combinators
 */
export const getFirst = dual(2, (self, key) => Option.map(Arr.findFirst(self, ([k]) => k === key), ([, value]) => value));
/**
 * @since 1.0.0
 * @category combinators
 */
export const getLast = dual(2, (self, key) => Option.map(Arr.findLast(self, ([k]) => k === key), ([, value]) => value));
/**
 * @since 1.0.0
 * @category combinators
 */
export const set = dual(3, (self, key, value) => Arr.append(Arr.filter(self, ([k]) => k !== key), [key, String(value)]));
/**
 * @since 1.0.0
 * @category combinators
 */
export const setAll = dual(2, (self, input) => {
 ...
 * @category combinators
 */
export const append = dual(3, (self, key, value) => Arr.append(self, [key, String(value)]));
/**
 * @since 1.0.0
 * @category combinators
 */
export const appendAll = dual(2, (self, input) => Arr.appendAll(self, fromInput(input)));
/**
 * @since 1.0.0
 * @category combinators
 */
export const remove = dual(2, (self, key) => Arr.filter(self, ([k]) => k !== key));
/**
 * @since 1.0.0
 ...
 * @category schema
 */
export const schemaFromString = Schema.transform(Schema.String, schemaFromSelf, {
    decode(fromA) {
