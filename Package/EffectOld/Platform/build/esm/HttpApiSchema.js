 ...
 */
export const AnnotationMultipart = Symbol.for("@effect/platform/HttpApiSchema/AnnotationMultipart");
/**
 * @since 1.0.0
 * @category annotations
 */
export const AnnotationMultipartStream = Symbol.for("@effect/platform/HttpApiSchema/AnnotationMultipartStream");
/**
 * @since 1.0.0
 * @category annotations
 */
export const AnnotationStatus = Symbol.for("@effect/platform/HttpApiSchema/AnnotationStatus");
/**
 * @since 1.0.0
 * @category annotations
 */
export const AnnotationEmptyDecodeable = Symbol.for("@effect/platform/HttpApiSchema/AnnotationEmptyDecodeable");
/**
 * @since 1.0.0
 * @category annotations
 */
export const AnnotationEncoding = Symbol.for("@effect/platform/HttpApiSchema/AnnotationEncoding");
/**
 * @since 1.0.0
 * @category annotations
 */
export const AnnotationParam = Symbol.for("@effect/platform/HttpApiSchema/AnnotationParam");
/**
 * @since 1.0.0
 * @category annotations
 */
 ...
 */
export const param = dual(2, (name, schema) => {
    const annotations = {
 ...
 */
export const Empty = (status) => Schema.Void.annotations(annotations({ status }));
/**
 * @since 1.0.0
 * @category empty response
 */
export const asEmpty = dual(2, (self, options) => Schema.transform(Schema.Void.annotations(self.ast.annotations), Schema.typeSchema(self), {
 ...
 * @category multipart
 */
export const MultipartTypeId = Symbol.for("@effect/platform/HttpApiSchema/Multipart");
/**
 * @since 1.0.0
 * @category multipart
 */
 ...
 * @category multipart
 */
export const MultipartStreamTypeId = Symbol.for("@effect/platform/HttpApiSchema/MultipartStream");
/**
 * @since 1.0.0
 * @category multipart
 */
 ...
 * @category encoding
 */
export const withEncoding = dual(2, (self, options) => self.annotations({
    [AnnotationEncoding]: {
        kind: options.kind,
 ...
 * @category encoding
 */
export const Text = (options) => withEncoding(Schema.String, { kind: "Text", ...options });
/**
 * @since 1.0.0
 * @category encoding
 */
export const Uint8Array = (options) => withEncoding(Schema.Uint8ArrayFromSelf, { kind: "Uint8Array", ...options });
const astCache = globalValue("@effect/platform/HttpApiSchema/astCache", () => new WeakMap());
/**
 * @since 1.0.0
 */
