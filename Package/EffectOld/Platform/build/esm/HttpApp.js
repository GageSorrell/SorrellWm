...
export const toHandled = (self, handleResponse, middleware) => {
    ...
    const withMiddleware = unify(middleware === undefined ?
...
const ejectedScopes = GlobalValue.globalValue("@effect/platform/HttpApp/ejectedScopes", () => new WeakSet());
...
export const toWebHandlerRuntime = (runtime) => {
    ...
    return (self, middleware) => {
        ...
        const httpApp = toHandled(self, (request, response) => {
            ...
            request[resolveSymbol](ServerResponse.toWeb(response, { withoutBody: request.method === "HEAD", runtime }));
            return Effect.void;
        }, middleware);
