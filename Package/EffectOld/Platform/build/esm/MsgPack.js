 ...
 * @category errors
 */
export const ErrorTypeId = Symbol.for("@effect/platform/MsgPack/MsgPackError");
/**
 * @since 1.0.0
 * @category errors
 */
 ...
 * @category combinators
 */
export const duplexSchema = dual(2, (self, options) => ChannelSchema.duplexUnknown(duplex(self), options));
/**
 * @since 1.0.0
 * @category schemas
 */
