...
/** @internal */
export const CommandTypeId = Symbol.for("@effect/platform/Command");
/** @internal */
export const isCommand = (u) => typeof u === "object" && u != null && CommandTypeId in u;
/** @internal */
export const env = dual(2, (self, environment) => {
    switch (self._tag) {
...
/** @internal */
export const feed = dual(2, (self, input) => stdin(self, Stream.fromChunk(Chunk.of(new TextEncoder().encode(input)))));
/** @internal */
...
/** @internal */
export const runInShell = dual(2, (self, shell) => {
    switch (self._tag) {
        case "StandardCommand": {
...
/** @internal */
export const pipeTo = dual(2, (self, into) => makePiped({
    left: self,
    right: into
}));
/** @internal */
export const stderr = dual(2, (self, output) => {
    switch (self._tag) {
        case "StandardCommand": {
...
/** @internal */
export const stdin = dual(2, (self, input) => {
    switch (self._tag) {
        case "StandardCommand": {
...
/** @internal */
export const stdout = dual(2, (self, output) => {
    switch (self._tag) {
        case "StandardCommand": {
...
/** @internal */
export const string = dual((args) => isCommand(args[0]), (command, encoding) => Effect.flatMap(commandExecutor.CommandExecutor, (executor) => executor.string(command, encoding)));
/** @internal */
export const workingDirectory = dual(2, (self, cwd) => {
    switch (self._tag) {
        case "StandardCommand": {
