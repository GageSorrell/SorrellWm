...
/** @internal */
export const TypeId = Symbol.for("@effect/platform/HttpServerRequest");
/** @internal */
export const serverRequestTag = Context.GenericTag("@effect/platform/HttpServerRequest");
/** @internal */
export const parsedSearchParamsTag = Context.GenericTag("@effect/platform/HttpServerRequest/ParsedSearchParams");
/** @internal */
...
class ServerRequestImpl extends Inspectable.Class {
    ...
    get stream() {
        return this.source.body
            ? Stream.fromReadableStream(() => this.source.body, (cause) => new Error.RequestError({
                request: this,
                reason: "Decode",
                cause
            }))
    ...
    get multipartStream() {
        return Stream.pipeThroughChannel(Stream.mapError(this.stream, (cause) => new Multipart.MultipartError({ reason: "InternalError", cause })), Multipart.makeChannel(this.headers));
    }
    arrayBufferEffect;
    get arrayBuffer() {
