...
/** @internal */
export const TypeId = Symbol.for("@effect/platform/CommandExecutor");
/** @internal */
export const ProcessTypeId = Symbol.for("@effect/platform/Process");
/** @internal */
export const ExitCode = Brand.nominal();
/** @internal */
export const ProcessId = Brand.nominal();
/** @internal */
export const CommandExecutor = GenericTag("@effect/platform/CommandExecutor");
/** @internal */
...
const collectUint8Array = Sink.foldLeftChunks(new Uint8Array(), (bytes, chunk) => Chunk.reduce(chunk, bytes, (acc, curr) => {
