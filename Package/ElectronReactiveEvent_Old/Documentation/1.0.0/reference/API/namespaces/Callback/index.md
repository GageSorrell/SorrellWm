...
| [EventRecord](type-aliases/EventRecord.md)             | A record of callbacks, such that the keys are `Channel`s, and the values are callbacks for event declarations given by their respective keys |
| [Main](type-aliases/Main.md)                           | `MainCallback`s live under `main`, _i.e._, they receive `renderer` events.                                                                   |
| [Renderer](type-aliases/Renderer.md)                   | `RendererCallback`s live under the `renderer`, _i.e._, they receive `main` events.                                                           |
