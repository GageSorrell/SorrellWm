...
export declare const DoTasks: <T>(...Tasks: TArray<TTaskTuple<T>>) => Promise<void>;
 ...
 * returned array.
 */
export declare const MapSome: <T, U>(InArray: TArray<T> | Readonly<TArray<T>>, Predicate: (Item: T) => (U | undefined)) => TArray<U>;
