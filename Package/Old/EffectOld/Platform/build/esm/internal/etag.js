...
/** @internal */
export const GeneratorTypeId = Symbol.for("@effect/platform/Etag/Generator");
/** @internal */
export const tag = Context.GenericTag("@effect/platform/Etag/Generator");
/** @internal */
...
/** @internal */
export const layer = Layer.succeed(tag, tag.of({
...
/** @internal */
export const layerWeak = Layer.succeed(tag, tag.of({
    [GeneratorTypeId]: GeneratorTypeId,
    fromFileInfo(info) {
