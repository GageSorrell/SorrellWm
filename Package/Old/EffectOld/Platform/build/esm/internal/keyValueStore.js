...
/** @internal */
export const TypeId = Symbol.for("@effect/platform/KeyValueStore");
/** @internal */
export const keyValueStoreTag = Context.GenericTag("@effect/platform/KeyValueStore");
/** @internal */
...
export const makeStringOnly = (impl) => {
    ...
    return make({
        ...
        set: (key, value) => typeof value === "string"
            ? impl.set(key, value)
            : Effect.suspend(() => impl.set(key, Encoding.encodeBase64(value)))
    });
};
/** @internal */
export const prefix = dual(2, ((self, prefix) => ({
    ...self,
...
/** @internal */
export const SchemaStoreTypeId = Symbol.for("@effect/platform/KeyValueStore/SchemaStore");
/** @internal */
...
export const layerFileSystem = (directory) => Layer.effect(keyValueStoreTag, Effect.gen(function* () {
    ...
    return make({
        ...
        clear: Effect.zipRight(fs.remove(directory, { recursive: true }), fs.makeDirectory(directory, { recursive: true })),
