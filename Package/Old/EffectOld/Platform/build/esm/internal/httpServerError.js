...
/** @internal */
export const TypeId = Symbol.for("@effect/platform/HttpServerError");
/** @internal */
export const isServerError = (u) => Predicate.hasProperty(u, TypeId);
/** @internal */
export const clientAbortFiberId = globalValue("@effect/platform/HttpServerError/clientAbortFiberId", () => FiberId.runtime(-499, 0));
/** @internal */
export const causeResponse = (cause) => {
    ...
    const responseEffect = !hasResponse && Cause.isInterruptType(stripped)
        ...
        : effect;
    const strippedCause = !hasResponse && Cause.isInterruptType(stripped) && isClientInterrupt
        ? Cause.interrupt(clientAbortFiberId)
        : stripped;
