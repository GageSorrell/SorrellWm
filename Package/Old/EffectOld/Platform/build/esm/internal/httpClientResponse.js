...
/** @internal */
export const TypeId = Symbol.for("@effect/platform/HttpClientResponse");
/** @internal */
...
class ClientResponseImpl extends Inspectable.Class {
    ...
    get stream() {
        return this.source.body
            ? Stream.fromReadableStream(() => this.source.body, (cause) => new Error.ResponseError({
...
/** @internal */
export const stream = (effect) => Stream.unwrap(Effect.map(effect, (_) => _.stream));
/** @internal */
export const matchStatus = dual(2, (self, cases) => {
...
/** @internal */
export const filterStatus = dual(2, (self, f) => Effect.suspend(() => f(self.status) ? Effect.succeed(self) : Effect.fail(new Error.ResponseError({
    response: self,
