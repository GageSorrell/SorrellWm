...
/** @internal */
export const TypeId = Symbol.for("@effect/platform/HttpBody");
/** @internal */
export const ErrorTypeId = Symbol.for("@effect/platform/HttpBody/HttpBodyError");
const bodyError = Data.tagged("HttpBodyError");
/** @internal */
export const HttpBodyError = (reason) => bodyError({ [ErrorTypeId]: ErrorTypeId, reason });
class BodyBase {
    [TypeId];
    constructor() {
        this[TypeId] = TypeId;
...
/** @internal */
export const empty = new EmptyImpl();
...
/** @internal */
export const unsafeJson = (body, contentType) => text(JSON.stringify(body), contentType ?? "application/json");
/** @internal */
...
export const jsonSchema = (schema, options) => {
    ...
    return (body, contentType) => Effect.flatMap(Effect.mapError(encode(body), (error) => HttpBodyError({ _tag: "SchemaError", error })), (body) => json(body, contentType));
};
/** @internal */
