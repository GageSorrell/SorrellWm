 ...
 */
export class Identifier extends Context.Tag("@effect/platform/OpenApi/Identifier")() {
}
/**
 * @since 1.0.0
 * @category annotations
 ...
 * @category annotations
 */
export class Description extends Context.Tag("@effect/platform/OpenApi/Description")() {
}
/**
 * @since 1.0.0
 * @category annotations
 ...
 * @category annotations
 */
export class ExternalDocs extends Context.Tag("@effect/platform/OpenApi/ExternalDocs")() {
}
/**
 * @since 1.0.0
 * @category annotations
 ...
 * @category annotations
 */
export class Deprecated extends Context.Tag("@effect/platform/OpenApi/Deprecated")() {
}
/**
 * @since 1.0.0
 * @category annotations
 ...
 * @category annotations
 */
export class Exclude extends Context.Reference()("@effect/platform/OpenApi/Exclude", {
 ...
 * @category annotations
 */
export const annotations = contextPartial({
...
const apiCache = globalValue("@effect/platform/OpenApi/apiCache", () => new WeakMap());
/**
...
const makeSecurityScheme = (security) => {
    ...
    switch (security._tag) {
        ...
        case "Bearer": {
            const format = Context.getOption(security.annotations, Format).pipe(Option.map((format) => ({ bearerFormat: format })), Option.getOrUndefined);
            return {
                ...meta,
                type: "http",
                scheme: "bearer",
