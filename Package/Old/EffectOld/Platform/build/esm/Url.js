 ...
 * @category Modifiers
 */
export const mutate = dual(2, (self, f) => {
 ...
 * @category Setters
 */
export const setHash = immutableURLSetter("hash");
/**
 ...
 * @category Setters
 */
export const setHost = immutableURLSetter("host");
/**
 ...
 * @category Setters
 */
export const setHostname = immutableURLSetter("hostname");
/**
 ...
 * @category Setters
 */
export const setHref = immutableURLSetter("href");
/**
 ...
 * @category Setters
 */
export const setPassword = dual(2, (url, password) => mutate(url, (url) => {
 ...
 * @category Setters
 */
export const setPathname = immutableURLSetter("pathname");
/**
 ...
 * @category Setters
 */
export const setPort = immutableURLSetter("port");
/**
 ...
 * @category Setters
 */
export const setProtocol = immutableURLSetter("protocol");
/**
 ...
 * @category Setters
 */
export const setSearch = immutableURLSetter("search");
/**
 ...
 * @category Setters
 */
export const setUsername = immutableURLSetter("username");
/**
 ...
 * @category Setters
 */
export const setUrlParams = dual(2, (url, searchParams) => mutate(url, (url) => {
 ...
 * @category Modifiers
 */
export const modifyUrlParams = dual(2, (url, f) => mutate(url, (url) => {
