 ...
 * @category type ids
 */
export const TypeId = Symbol.for("@effect/platform/HttpIncomingMessage");
/**
 * @since 1.0.0
 * @category schema
 */
 ...
 * @category fiber refs
 */
export class MaxBodySize extends Context.Reference()("@effect/platform/HttpIncomingMessage/MaxBodySize", {
 ...
 * @category fiber refs
 */
export const withMaxBodySize = dual(2, (effect, size) => Effect.provideService(effect, MaxBodySize, Option.map(size, FileSystem.Size)));
/**
 * @since 1.0.0
 */
