 ...
 * @category type ids
 */
export const TypeId = Symbol.for("@effect/platform/HttpApiSecurity");
const Proto = {
    [TypeId]: TypeId,
    pipe() {
 ...
 */
export const bearer = Object.assign(Object.create(Proto), {
    _tag: "Bearer",
 ...
 * @category constructors
 */
export const basic = Object.assign(Object.create(Proto), {
    _tag: "Basic",
    annotations: Context.empty()
});
/**
 ...
 */
export const annotateContext = dual(2, (self, context) => Object.assign(Object.create(Proto), {
    ...self,
 ...
 * @category annotations
 */
export const annotate = dual(3, (self, tag, value) => Object.assign(Object.create(Proto), {
    ...self,
