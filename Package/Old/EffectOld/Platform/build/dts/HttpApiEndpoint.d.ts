...
export declare namespace HttpApiEndpoint {
    ...
    }) & ([_Payload] extends [never] ? {} : _Payload extends Brand<HttpApiSchema.MultipartStreamTypeId> ? {
     ...
     * @category models
     */
    type RequestRaw<Endpoint extends Any> = Endpoint extends HttpApiEndpoint<infer _Name, infer _Method, infer _Path, infer _UrlParams, infer _Payload, infer _Headers, infer _Success, infer _Error, infer _R, infer _RE> ? ([_Path] extends [never] ? {} : {
        readonly path: _Path;
    }) & ([_UrlParams] extends [never] ? {} : {
        readonly urlParams: _UrlParams;
    }) & ([_Headers] extends [never] ? {} : {
    ...
    }) & ([Payload] extends [never] ? {} : Payload extends infer P ? P extends Brand<HttpApiSchema.MultipartTypeId> | Brand<HttpApiSchema.MultipartStreamTypeId> ? {
     ...
     * @category models
     */
    type Handler<Endpoint extends Any, E, R> = (request: Types.Simplify<Request<Endpoint>>) => Effect<Success<Endpoint> | HttpServerResponse, Error<Endpoint> | E, R>;
    /**
     * @since 1.0.0
     * @category models
     */
    type HandlerRaw<Endpoint extends Any, E, R> = (request: Types.Simplify<RequestRaw<Endpoint>>) => Effect<Success<Endpoint> | HttpServerResponse, Error<Endpoint> | E, R>;
    /**
     * @since 1.0.0
     * @category models
     */
     ...
     * @category models
     */
    type HandlerRawWithName<Endpoints extends Any, Name extends string, E, R> = HandlerRaw<WithName<Endpoints, Name>, E, R>;
    /**
     * @since 1.0.0
     * @category models
     */
     ...
     * @category models
     */
    type ValidateParams<Schemas extends ReadonlyArray<Schema.Schema.Any | Schema.PropertySignature.Any>, Prev extends (Schema.Schema.Any | Schema.PropertySignature.Any) = never> = Schemas extends [
        ...
        Head extends HttpApiSchema.Param<infer _Name, infer _S> ? HttpApiSchema.Param<_Name, any> extends Prev ? `Duplicate param: ${_Name}` : [Schema.Schema.Encoded<Head> & {}] extends [string] ? Head : `Must be encodeable to string: ${_Name}` : Head,
     ...
     * @category models
     */
    type PathEntries<Schemas extends ReadonlyArray<Schema.Schema.Any | Schema.PropertySignature.Any>> = Extract<keyof Schemas, string> extends infer K ? K extends keyof Schemas ? Schemas[K] extends HttpApiSchema.Param<infer _Name, infer _S> ? [_Name, _S] : Schemas[K] extends (Schema.Schema.Any | Schema.PropertySignature.Any) ? [K, Schemas[K]] : never : never : never;
    type OptionalTypePropertySignature = Schema.PropertySignature<"?:", any, PropertyKey, Schema.PropertySignature.Token, any, boolean, unknown> | Schema.PropertySignature<"?:", any, PropertyKey, Schema.PropertySignature.Token, never, boolean, unknown> | Schema.PropertySignature<"?:", never, PropertyKey, Schema.PropertySignature.Token, any, boolean, unknown> | Schema.PropertySignature<"?:", never, PropertyKey, Schema.PropertySignature.Token, never, boolean, unknown>;
    /**
     * @since 1.0.0
     * @category models
     */
    type ExtractPath<Schemas extends ReadonlyArray<Schema.Schema.Any | Schema.PropertySignature.Any>> = Schema.Simplify<{
        readonly [Entry in Extract<PathEntries<Schemas>, [any, OptionalTypePropertySignature]> as Entry[0]]?: Schema.Schema.Type<Entry[1]>;
    } & {
        readonly [Entry in Exclude<PathEntries<Schemas>, [any, OptionalTypePropertySignature]> as Entry[0]]: Schema.Schema.Type<Entry[1]>;
    }>;
    /**
     * @since 1.0.0
     * @category models
     */
    type Constructor<Name extends string, Method extends HttpMethod> = <const Schemas extends ReadonlyArray<Schema.Schema.Any | Schema.PropertySignature.Any>>(segments: TemplateStringsArray, ...schemas: ValidateParams<Schemas>) => HttpApiEndpoint<Name, Method, Schemas["length"] extends 0 ? never : Types.Simplify<ExtractPath<Schemas>>, never, never, never, void, never, Schema.Schema.Context<Schemas[number]>>;
}
/**
 * @since 1.0.0
