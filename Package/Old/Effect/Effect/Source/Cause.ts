 ...
 *
 * ```ts
 * import { Cause } from "@sorrell/effect"
 *
...
export declare namespace Cause {
   ...
   *
   * ```ts
   * import type { Cause } from "@sorrell/effect"
   *
   * // string
 ...
 *
 * ```ts
 * import { Cause, Result } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Option } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Effect, Queue } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 * ```ts
 * import { Cause } from "@sorrell/effect"
 * import type { Fiber } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Context } from "@sorrell/effect"
 *
