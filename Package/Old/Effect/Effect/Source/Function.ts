 ...
 *
 * ```ts
 * import type { Function, HKT } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Function, pipe } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Function, pipe, String } from "@sorrell/effect"
 ...
 *
 * ```ts
 * import type { Function } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 ...
 *
 * ```ts
 * import { identity } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 ...
 *
 * ```ts
 * import { absurd } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { pipe } from "@sorrell/effect"
 *
 * const result = pipe(
 *   1,
 *   (n) => n + 1,
 ...
 *
 * ```ts
 * import { Array, pipe } from "@sorrell/effect"
 *
 * const numbers = [1, 2, 3, 4]
 * const double = (n: number) => n * 2
 * const greaterThanFour = (n: number) => n > 4
 ...
 *
 * ```ts
 * import { flow } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 ...
 *
 * ```ts
 * import { hole } from "@sorrell/effect"
 *
