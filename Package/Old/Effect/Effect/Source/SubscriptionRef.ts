 ...
 *
 * ```ts
 * import { Deferred, Effect, Fiber, Stream, SubscriptionRef } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, SubscriptionRef } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Effect, Option, SubscriptionRef } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const ref = yield* SubscriptionRef.make(10)
 *
