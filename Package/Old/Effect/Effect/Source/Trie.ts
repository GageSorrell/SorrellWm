 ...
 *
 * ```ts
 * import { Trie } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Equal, Trie } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 ...
 *
 * ```ts
 * import { Option, Trie } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 * const trie = Trie.empty<number>().pipe(
 *   Trie.insert("call", 0),
 ...
 *
 * ```ts
 * import { Equal, Result, Trie } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
 * const trie = Trie.empty<number>().pipe(
 *   Trie.insert("shells", 0),
 ...
 *
 * ```ts
 * import { Equal, Option, Trie } from "@sorrell/effect"
 * import * as assert from "node:assert"
 *
