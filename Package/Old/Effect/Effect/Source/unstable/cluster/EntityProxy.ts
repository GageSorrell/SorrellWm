 ...
 *
 * ```ts
 * import { Layer, Schema } from "@sorrell/effect"
 * import { ClusterSchema, Entity, EntityProxy, EntityProxyServer } from "@sorrell/effect/unstable/cluster"
 * import { Rpc, RpcServer } from "@sorrell/effect/unstable/rpc"
 *
 ...
 * import { Layer, Schema } from "@sorrell/effect"
 * import { ClusterSchema, Entity, EntityProxy, EntityProxyServer } from "@sorrell/effect/unstable/cluster"
 * import { HttpApi, HttpApiBuilder } from "@sorrell/effect/unstable/httpapi"
 * import { Rpc } from "@sorrell/effect/unstable/rpc"
 *
 * export const Counter = Entity.make("Counter", [
 *   Rpc.make("Increment", {
 *     payload: { id: Schema.String, amount: Schema.Number },
