 ...
 *
 * ```ts
 * import type { TxQueue } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, TxQueue } from "@sorrell/effect"
 ...
 *
 * ```ts
 * import { TxQueue } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Option, TxQueue } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const queue = yield* TxQueue.bounded<number>(10)
 *
 ...
 *
 * ```ts
 * import { Array, Effect, TxQueue } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const queue = yield* TxQueue.bounded<number, string>(10)
 ...
 *
 * ```ts
 * import { Cause, Effect, TxQueue } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 *   const queue = yield* TxQueue.bounded<number>(10)
 *
