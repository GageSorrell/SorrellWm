 ...
 *
 * ```ts
 * import { Console, Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import type { HKT, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import type { Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Channel, Console, Effect, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Context, Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Context, Effect, Option, Stream } from "@sorrell/effect"
 *
 * class Greeter extends Context.Service<Greeter, {
 *   readonly greet: (name: string) => string
 * }>()("Greeter") {}
 ...
 *
 * ```ts
 * import { Console, Effect, Random, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, Schedule, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, Scope, Stream } from "@sorrell/effect"
 *
 * const stream = Stream.make(1, 2, 3)
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Queue, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Console, Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Cause, Console, Effect, Exit, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Context, Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Fiber, PubSub, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, Exit, PubSub, Stream, Take } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Data, Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Data, Effect, Stream } from "@sorrell/effect"
 *
 * class StreamError extends Data.TaggedError("StreamError")<{ readonly cause: unknown }> {}
 *
 ...
 *
 * ```ts
 * import { Console, Effect, PubSub, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Option, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Array, Console, Effect, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, Result, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, Ref, Sink, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Array, Console, Effect, Exit, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, Sink, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Context, Effect, ExecutionPlan, Layer, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, pipe, Stream } from "@sorrell/effect"
 *
 * Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Duration, Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Console, Effect, Schedule, Sink, Stream } from "@sorrell/effect"
 *
 * Effect.runPromise(Effect.gen(function* () {
 *   const aggregated = yield* Stream.runCollect(
 *     Stream.make(1, 2, 3, 4, 5, 6).pipe(
 ...
 *
 * ```ts
 * import { Array, Channel, Console, Effect, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Array, Channel, Effect, Stream } from "@sorrell/effect"
 *
 * type NumberChunk = readonly [number, ...Array<number>]
 *
 ...
 *
 * ```ts
 * import { Console, Deferred, Effect, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
 ...
 *
 * ```ts
 * import { Console, Effect, Exit, Stream } from "@sorrell/effect"
 *
 * const stream = Stream.make(1, 2, 3).pipe(
 *   Stream.onExit((exit) =>
 *     Exit.isSuccess(exit)
 ...
 *
 * ```ts
 * import { Console, Context, Effect, Layer, Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Context, Stream } from "@sorrell/effect"
 *
 * const stream = Stream.make(1, 2, 3, 4, 5)
 ...
 *
 * ```ts
 * import { Stream } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Effect, Queue, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function* () {
 ...
 *
 * ```ts
 * import { Cause, Effect, Queue, Stream } from "@sorrell/effect"
 *
 * const program = Effect.gen(function*() {
