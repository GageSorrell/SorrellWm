 ...
 *
 * ```ts
 * import { Optic } from "@sorrell/effect"
 *
 ...
 *
 * ```ts
 * import { Optic, Result } from "@sorrell/effect"
 *
 * type Shape =
 ...
 *
 * ```ts
 * import { Optic, Result, Schema } from "@sorrell/effect"
 *
...
export interface Optional<in out S, in out A> {
   ...
   *
   * ```ts
   * import { Optic, Option } from "@sorrell/effect"
   *
   ...
   *
   * ```ts
   * import { Optic, Schema } from "@sorrell/effect"
   *
 ...
 *
 * ```ts
 * import { Optic, Option, Result } from "@sorrell/effect"
 *
