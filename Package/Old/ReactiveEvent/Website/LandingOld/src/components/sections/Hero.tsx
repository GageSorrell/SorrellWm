            ...
            <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-20">
                <div className="flex flex-col md:flex-row md:gap-x-6 lg:gap-x-0 xl:grid xl:grid-cols-2 mt-4">
                    <div className="shrink-0 md:w-1/2 lg:w-7/12 xl:w-auto">
                        ...
                        <Checklist
                            items={ [
                                "Events as types (with request, response, and error types)",
                                "Always know what data will be sent and received",
                                "Modern React hooks (with support for suspense and transitions)",
                                "Boilerplate written for you with our CLI tool"
                            ] }
                        />
                        <div className="mt-10 flex flex-col sm:flex-row items-start gap-3">
                            <Button href="/docs/article/getting-started">
                                Get Started
                            </Button>
                        </div>
                    </div>
