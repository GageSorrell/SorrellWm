...
/**
 * Initializes the Windows API message loop created by `@sorrell/wm-windows`.
 *
 * @todo The signatures of the arguments are probably wrong.
 *
 * @param {() => void} _EmptyCallback - An empty callback, currently unused.
 */
export function InitializeMessageLoop(_EmptyCallback: (() => void)): void;
 ...
 *
 * @param {HWindow} Handle - The handle to cover.
 */
