...
excerpt: Effect Hamburg Meetup on Sept 5th. Dedicated support channels for companies using Effect. Twitch-Spotify Integration, Rebuilding ContentLayer & Building a GitHub Action coding sessions. 
date: 2025-08-29
authors:
  - davide_scognamiglio
  - mirela_prifti
...
- Using Effect at your company and need custom support? Get in touch with the Effect team on [Discord](https://discord.gg/effect-ts) or Twitter, we're here for you!
  <Tweet id="1960667002735091859" />

&nbsp;

- We're very excited for the [first Effect Hamburg Meetup](https://luma.com/44razg6s) coming up on Friday, Sept 5th. 
  <Tweet id="1960296165230219431" />

&nbsp;

- Theo mentioned Effect in one of his videos about the [recent state of his stack](https://youtu.be/3c4UyGRBnmM?t=2635) (around 43:55), acknowledging the benefits of "effectifying" their codebase, especially for error management and tracing!
...
- [`@effect-native/bun-test`](https://github.com/effect-native), a package that simplifies running tests for Effect-based code with `bun:test`, was realeased this week by Tom Aylott.

&nbsp;

- [Macrowave](https://www.producthunt.com/products/macrowave), a **P2P radio broadcasting app** with Effect powering the entire backend, by [Neco](https://github.com/Necmttn)! 
