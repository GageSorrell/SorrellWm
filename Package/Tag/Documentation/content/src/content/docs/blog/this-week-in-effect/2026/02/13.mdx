...
excerpt: Effect-viz, an Effect runtime visualizer. Lalph AI Agent Orchestrator 3 and Office Hours 15 coding sessions.
date: 2026-02-13
authors:
  - davide_scognamiglio
  - mirela_prifti
...
### Effect AI
- [Fix(ai-openrouter): deduplicate reasoning parts when streaming](https://github.com/Effect-TS/effect/pull/6060) (Bug Fix)

### Effect Cluster
- [Fix(cluster): HttpLayerRouter variants for route registration in HttpRunner](https://github.com/Effect-TS/effect/pull/6056) (Bug Fix)

### Effect Platform
- [Backport HttpBody/HttpServerResponse contentType improvements](https://github.com/Effect-TS/effect/pull/6050) (Bug Fix)

### Effect RPC
- [Fix(rpc): encode defects with Schema.Defect in sendRequestDefect and](https://github.com/Effect-TS/effect/pull/6055) (Bug Fix)
...
- [`effect-viz`](https://github.com/topheman/effect-viz) - An Effect runtime visualizer for understanding the execution of Effect code in the browser. Project by [topheman](https://github.com/topheman).
  ...
  <Tweet id="2021857808283525545" />


&nbsp;

- [`effortless-aws`](https://github.com/kondaurovDev/effortless-aws/tree/main) - a TypeScript framework for AWS serverless that derives infrastructure directly from your code. Project by [kondaurovDev](https://github.com/kondaurovDev).

&nbsp;

- [`effect-tg`](https://github.com/grom-dev/effect-tg) - a library for creating Telegram Bots with Effect. Project by [grom-dev](https://github.com/grom-dev).
...
- [`bsky-cli`](https://github.com/mepuka/bsky-cli) - An agent-first Bluesky data filtering and monitoring CLI built with Effect. Project by [mepuka](https://github.com/mepuka).

&nbsp;

- [`EffectPatterns`](https://github.com/PaulJPhilp/EffectPatterns) has been updated with 81 new patterns, 75 of which are Effect Schema patterns. Project by [PaulJPhilp](https://github.com/PaulJPhilp).
...
- Lalph AI Orchestrator: Setting Up Secure and Autonomous AI Workflows

<YouTube
  id="https://www.youtube.com/embed/waFD0ld7QkY?si=8sMZz_ntJQpXOeth"
  title="Lalph AI Orchestrator: Setting Up Secure and Autonomous AI Workflows"
/>
