...
export type ListrContext = unknown;

/**
 * Options to set the behavior of Listr.
 */
export interface ListrOptions<ContextType = ListrContext>
{
    /**
     ...
     *
     * This is independent of \`exitOnError`, since failure of a rollback can
     * be a more critical operation comparing to failing a single task.
     *
    ...
    /**
     * Listr will track SIGINIT signal to update the renderer one last time before failing,
     * therefore it needs to register exit listeners.
     *
     * @default true
     */
...
export interface ListrSubClassOptions<
    ContextType = ListrContext,
    Renderer extends ListrRendererSubclass = ListrRendererSubclass,
    FallbackRenderer extends ListrRendererSubclass = ListrRendererSubclass
> extends
    Omit<ListrOptions<ContextType>,
