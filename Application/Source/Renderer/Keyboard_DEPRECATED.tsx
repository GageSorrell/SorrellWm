 ...
 */
export const UseKeyCombination_DEPRECATED = (KeyCombination: FKeyCombination): void =>
{
 ...
 */
export const UsePersistentKeyCombination_DEPRECATED = (KeyCombination: FKeyCombination): (() => void) =>
{
    const { RegisterKeyCombination, UnregisterKeyCombination } = UseKeyboardContext();
...
export type CKeyboard_DEPRECATED =
{
...
export const KeyboardProvider_DEPRECATED = ({ children }: PropsWithChildren): ReactNode =>
{
