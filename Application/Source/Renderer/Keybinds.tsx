...
// {
//     [key: string]: Array<(e?: KeyboardEvent) => any>;
// }
...
// export const ShortcutProvider = memo(
//     ({ children, ...props }: PropsWithChildren<IShortcutProviderProps>) =>
//     {
...
//             (e: KeyboardEvent) =>
//             {
//                 // Ignore F24 so it does not affect keybinds
//                 if (e.key?.toLowerCase() === "f24")
//                 {
//                     return;
//                 }
...
//             keysDown.current = keysDown.current.filter((currentKey) => keysUp.indexOf(currentKey) < 0);
...
//             (method: () => any, keys: Array<string> = [], title: string, description: string) =>
//             {
//                 const nextShortcuts = [ ...shortcuts.current ];
...
//             unregisterShortcut,
//             setEnabled
//         }) satisfies IShortcutProviderRenderProps,
//             [
//                 shortcutsState,
//                 registerShortcut,
//                 registerSequenceShortcut,
...
export const ShortcutProvider = memo(
  ({ children, ...props }: PropsWithChildren<IShortcutProviderProps>) =>
  {
     ...
     */
    const registerSequenceShortcut = useCallback(
      (method: () => any, keys: string[] = [], title: string, description: string) =>
      {
        const nextShortcuts = [...shortcuts.current];
