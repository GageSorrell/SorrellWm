...
export const GetNextIndex = (Vertex: FVertex): number | undefined =>
{
    ...
    if (Parent !== undefined)
    {
        const CurrentIndex: number = Parent.Children.indexOf(Vertex);
...
export const GetNextSibling = (Vertex: FVertex): FVertex | undefined =>
{
    ...
    if (Parent !== undefined)
    {
        const NextIndex: number | undefined = GetNextIndex(Vertex);
...
export const GetPreviousSibling = (Vertex: FVertex): FVertex | undefined =>
{
    ...
    if (Parent !== undefined)
    {
        const PreviousIndex: number | undefined = GetPreviousIndex(Vertex);
...
RegisterInitializationFunction("Tree", InitializeTree, [ "Monitor" ]);
